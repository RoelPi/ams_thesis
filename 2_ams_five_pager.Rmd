...
Need @williamson1985 [72] here. Departing from Coase!

@canback1998 [31] does a solid job explaining the role of transaction costs, and how consultants fit into that picture. "As companies strive to reduce the production costs by exploiting scale and scope economies, they must specialise -- which in turn leads to a need for internal coordination. If transaction costs did not exist, then the largest company in each market would also be the most profitable company, since coordination between functions could be achieved without effort. But because of transaction costs, this does not happen." The result is that blue-collar jobs disappear as production costs are reduced, while white-collar jobs, aimed at coordination, do not. 

Since managers are only boundedly rational, the assumption is that there is a high demand for advice and (IT) solutions that improve coordination within and between firms. Services in which consultants are particularly well-versed. The question to ask here is: is the transaction cost for working with external consultants lower than for working with internal consultants when it comes to knowledge production? 

@canback1998 [37-44] argues it does. According to his interpretation of transaction cost economics, the choice depends on three factors.

1. The degree of asset specificity: do physical, human or site assets have a specific usage and can they not be put to use for another purpose? Higher asset specificity leads to internalization, since no vendor is willing to tailor his product or service to one client, facing downward price pressure, since the latter acts as a monopsonist [@robinson1969 218-228].
2. Uncertainty: business cycle volatility and technical uncertainty lead to more coordination and bureaucratic transactions since it is hard and expensive to work with contracts that cover a wide range of contexts and possible outcomes. Consequently, uncertainty leads to internalization.
3. The frequency of transactions: if transactions are frequent, there will be a higher bureaucratic cost involved, once again leading to a tendency to internalize the good or service.

@canback1998 [37] argues that it's mainly human asset specificity that favor using consultants, since their assignments typically have a human low asset specificity, since the solution or advice can be reproduced at many organizations. While it is true that consultancy assignments involve relatively few transactions (often a single one), Canback claims that transaction frequency and uncertainty are less of an influence. By referring to market uncertainty, he obscures the fact that consultants rather thrive in a context with high complexity and uncertainty. This is a prime example of the vagueness surrounding the concept of uncertainty.

Within the context of transaction cost economics, @shin2003 [38] states that "many empirical studies show mixed and contradictory results against what transaction cost economics predicts, especially for the concept of uncertainty." and as a solution, reduces the concept to "behavioral uncertainty". This is in line with @williamson1985 [79] who claims that "The proposed match of governance structures with transactions considers only two of the three dimensions for describing transactions: asset specificity and frequency. The third dimension, uncertainty, is assumed to be present in sufficient degree to pose an adaptive, sequential decision problem. [...] Since continuity now matters, [...] uncertainty makes it more imperative to organize transactions within governance structures that have the capacity to 'work things out.'"

To summarize: asset specificity may lead to opportunism. In other words, behavioral uncertainty arises from asset specificity, but only in recurrent transactions. In this context, behavioral uncertainty can't be disentangled from asset specificity.

Since consultancy firms can make the most money when they commoditize (recurrent transaction, albeit with different buyers) their strategies or solutions, TCE predicts that they will stay away from assignments with high asset specificity. <I need a citation on the commoditization part>
...
Another theory that falls in the camp of the critical view is that of economic signaling theory [@armbruster2006 8-10]. Unlike sociological institutionalism, it treats the economic actors as experienced and knowledgeable, and not as part of an institution. Signaling theory argues that in uncertain markets, suppliers invest in features that signal status, quality and reliability. In consulting this translates into degrees, certificates, using the adequate buzzwords, wearing a suit and driving a quality car.
