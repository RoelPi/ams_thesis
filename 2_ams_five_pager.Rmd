...
@canback1998 [37] argues that it's mainly human asset specificity that favor using consultants, since their assignments typically have a human low asset specificity, since the solution or advice can be reproduced at many organizations. While it is true that consultancy assignments involve relatively few transactions (often a single one), Canback claims that transaction frequency and uncertainty are less of an influence, obscuring the fact that consultants rather thrive in a context with high complexity and uncertainty.
