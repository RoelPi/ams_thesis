...
### Knowledge Transfer & Diffusion (TODO)
...
Before discussing the results, there are some side notes to be mindful of.
* Multiple respondents are not on the payroll of the company, but work as a freelancer through a management enterprise--which is typical in Belgium.
* Some respondents had a hard time disentangling the concept of disentangling the concepts of a freelancer, temporary worker, agency and consultant, even after receiving a lengthy written briefing. The concept of a consultant was always clarified through six properties from the definition (supra). Many responses required followup questions about the nature of party involved. For example, off-shore workers _can_ be consultants, but aren't necessarily so.
