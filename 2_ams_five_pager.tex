...
\subsubsection{Digital Consultancy is
...
The following IT services are often outsourced: applications development
and maintenance, systems operations, network management, end-user
support, systems planning and management, purchase of software.

According to \citet[68-69]{willcocks1995} most outsourcing arrangements
can be located on four spectra:

\begin{itemize}
\tightlist
\item
  Focus: control through contract vis-à-vis results through trust and
  partnership
\item
...
\hypertarget{it-management-ad-interim}{%
\paragraph{IT Management Ad Interim}\label{it-management-ad-interim}}
...
\hypertarget{it-outsourcing-1}{%
\paragraph{IT Outsourcing}\label{it-outsourcing-1}}
