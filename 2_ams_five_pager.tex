...
\hypertarget{emergence-of-digital-consultancy-todo}{%
\section{Emergence of Digital Consultancy
(TODO)}\label{emergence-of-digital-consultancy-todo}}
...
efficiency. For example, \citet[120]{jayatilaka2006} argue that
``{[}i{]}nitiatives to follow other companies in IS sourcing
arrangements could originate from IS and managerial professionals
working in the companies and consultants who are aware of successful
outsourcing arrangements. Mimetic isomorphism occurs when companies
follow the lead of other companies that have successfully outsourced
IT.''
...
\hypertarget{types-of-opportunism}{%
...
\hypertarget{ex-ante-opportunism-adverse-selection}{%
...
\hypertarget{no-professionalization}{%
...
\hypertarget{no-regulation-todo}{%
...
\hypertarget{ex-post-opportunism-moral-hazard}{%
...
and agent during the cooperation. The ways that moral hazard can occur
between an organizations and its consultants are plenty:
...
Especially relevant for consulting is the fact that most engagements are
embedded in a flexible contract, due to a variety of various reasons:
the target state of a project might change due to evolving technology
and business environment, an organization might want to shift some
problems and issues to another firm, and finally ``in each subsequent
year, the contract payment stream becomes less and less tied to the
initial set of planned outputs (as the world changes) and, thus, more
subject to negotiation and misunderstanding.'' \citep[ 9]{mcfarlan1995}

\citet[924]{nooteboom1996} agrees: while most inter-firm cooperation is
described in a contract of some form, detailed contracts can shroud a
contract in an atmosphere of mistrust, derailing the relation before it
has even started.

At first sight, the work by \citet[4]{lacity2012} seems contradictory to
these findings, as it describes that there is substantial evidence that
...
opportunities. On the other hand, it decreases their formal
accountability.

\hypertarget{opportunism-in-digital-consultancy}{%
...
\hypertarget{preventing-opportunism}{%
...
\hypertarget{preventing-adverse-selection}{%
...
\hypertarget{purchasing-regulation-procurement-todo}{%
\paragraph{Purchasing Regulation (\textasciitilde procurement,
TODO)}\label{purchasing-regulation-procurement-todo}}
...
\hypertarget{third-party-assessment-todo}{%
\paragraph{Third-Party Assessment
(TODO)}\label{third-party-assessment-todo}}
...
conduct and sensitivity when dealing with confidential information.

\hypertarget{preventing-moral-hazard}{%
\subsubsection{Preventing Moral Hazard}\label{preventing-moral-hazard}}

\hypertarget{monitoring-todo}{%
\paragraph{Monitoring (TODO)}\label{monitoring-todo}}
...
\hypertarget{whistleblowing-todo}{%
\paragraph{Whistleblowing (TODO)}\label{whistleblowing-todo}}

Also media.

\hypertarget{incentivization-todo}{%
\paragraph{Incentivization (TODO)}\label{incentivization-todo}}
...
\hypertarget{third-party-moderation-todo}{%
\paragraph{Third-Party Moderation
(TODO)}\label{third-party-moderation-todo}}
...
\hypertarget{first-party-assessment-todo}{%
\paragraph{First-Party Assessment
(TODO)}\label{first-party-assessment-todo}}
...
\hypertarget{relational-mechanisms}{%
\paragraph{Relational Mechanisms}\label{relational-mechanisms}}

According to the research by \citet[4-5]{lacity2012} relational
governance is operationalised most frequently as ``effective knowledge
sharing, communication, trust, and viewing the provider as a partner.''
Nevertheless, ``contractual governance and relational governance are not
substitutes in that a poorly crafted contract cannot be overcome with
friendly, communicative, and trusting account managers. Poor contracts,
we have found, can make for poor relationships.''
...
\hypertarget{cooperative-level-contracts}{%
