...
``On the other hand, as pointed out by Lacity and Hirschheim {[}22{]},
political motivations also play a role. Reponen {[}34{]}, for instance,
found that outsourc ing decisions were sometimes motivated by the
difficulties organizations had in managing their IS function. Among
these are: the lack of efficiency and effectiveness of IS departments,
the difficulty of assessing IS productivity and of evaluating tangible
benefits of IS investments, and the low quality of the services rendered
by the IS departments. Lacity and Hirschheim also identify a number of
political motives, where the managers''react to the efficiency
imperative, acquire or justify additional resources, react to positive
outsourcing media reports, reduce uncertainty, eliminate a burdensome
function, and enhance credibility'' ({[}22{]}, p.~258). \citep[
52]{aubert1996}

``Management consultants were valued for energizing the change efforts
and pushing the change projects forward. As one of the managers
expressed it:''The consultants chased us so that we really implemented
the change.'' In supporting the realization of change projects,
consultants provided methodology as well as an ``energizing example''
with their own style of working.'' \citep[ 54]{werr2002}
...
Typically, as they acquire new resources, firms can specialize,
...
when it comes to knowledge production regarding the improvement of
...
and instead, buys it in the market, it encounters various agency
problems (and accompanying costs to offset them): information asymmetry,
ambiguity of measurement and goal incompatibility. These agency problems
lead to adverse selection and moral hazard. \citep[ 14]{rousseau1993}
...
\item
  The ambiguity of the measurement of individual performance: when a
...
exceeds the benefits.'' \citep[ 327]{fama1983} The following
expenditures sum up to the total amount of agency costs \citep[
308]{jensen1976}:
...
Agency theory ``proposes that the adoption of appropriate governance
structures for policing the relationship between principals and agents
can economize on agency costs.'' \citep{godfrey1995}
